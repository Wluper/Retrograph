...
for config in "SST2_16_3e-05_3/model.ckpt-12627","SST2" "CoLA_16_2e-05_4/model.ckpt-2137","CoLA" "MRPC_16_2e-05_3/model.ckpt-687","MRPC" "RTE_16_3e-05_4/model.ckpt-622","RTE"; do
    IFS=","
    set -- $config
    echo $1 and $2
    TASK=$2
...
# this is a tuple of trained model and task, you can add more tuples
for config in "QQP_16_3e-05_4/model.ckpt-90962","QQP" "MNLI_16_3e-05_4/model.ckpt-98175","MNLI" "QNLIV2_16_3e-05_3/model.ckpt-19639","QNLIV2"; do
    IFS=","
    set -- $config
    echo $1 and $2
    TASK=$2
...
# this is a tuple of trained model and task, you can add more tuples
# TODO: Do another dev set evaluation
for config in "MNLI_16_3e-05_4/model.ckpt-98175","MNLI"; do
    IFS=","
    set -- $config
    echo $1 and $2
    TASK=$2
...
for config in "MNLI_16_3e-05_4/model.ckpt-98175","diagnostic"; do
    IFS=","
    set -- $config
    echo $1 and $2
    TASK=$2
