# Source: https://github.com/jonathanherzig/commonsenseqa
...
from siqa_preprocessor import InputExample, SIQAProcessor
...
def main(_):
  ...
  processor = SIQAProcessor(variant=FLAGS.variant)
